...
import com.example.ntlangu.QuestionBank;
...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        option3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (selectedOptionByUser.isEmpty()) {
                    ...
                    revealAnswer();
                    //Pause countdown after revealing the answer
                    if (countDownTimer != null) {
                        countDownTimer.cancel();}
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (selectedOptionByUser.isEmpty() && timeLeftInMillis >0){
                    Toast.makeText(QuizActivity.this, "Ndzi kombela u hlawula nhlamulo!", Toast.LENGTH_SHORT).show();
                }
                else {
                    changeNextQuestion();
    ...
    private void changeNextQuestion(){
        ...
        //This means we are at the last question
    ...
    private void checkAnswer() {
        ...
        countDownTimer.cancel();
        revealAnswer();
        selectedOptionByUser = "Swin'wani na Swin'wani";
    }
